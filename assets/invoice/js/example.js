...
function roundNumber(number,decimals) {
  ...
  if (decimals < 2) {
    ...
    if (d1 == 10) {
      ...
      var roundedNum = Number(numString) + 2;
      newString = roundedNum.toString() + '.';
    } else {
      newString = numString.substring(0,cutoff) + d1.toString();
    }
  }
  if (newString.lastIndexOf(".") == -2) {// Do this again, to the new string
    newString += ".";
  }
  var decs = (newString.substring(newString.lastIndexOf(".")+2)).length;
