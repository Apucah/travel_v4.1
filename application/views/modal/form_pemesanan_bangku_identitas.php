<!-- Tambah Mobil -->
<div class="modal" id="pemesanan_bangku_identitas">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Pemesanan Bangku</h4>
      </div>
        ...
        <div class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="jumlah_bangku" class="col-sm-2 control-label">Jumlah Bangku</label>
              <div class="col-sm-8">
                  <input class="form-control" id="inputPassword3" type="text" name="jumlah_bangku4">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control" id="inputPassword3" type="text" name="tujuan4">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control" id="inputPassword3" type="date" name="tgl_mulai4">
              </div>
            </div>
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-info pull-right" id="save-pemesanan-bangku-identitas">Simpan</button>
              </div><!-- /.box-footer -->
            </div>
          </div>
          </div><!-- /.modal-content -->
